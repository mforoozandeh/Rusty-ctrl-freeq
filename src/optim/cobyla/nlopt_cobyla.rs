...
unsafe fn nlopt_stop_x(
    ...
    i = 0 as ::core::ffi::c_uint;
    while i < (*s).n {
        if (*x.offset(i as isize) - *oldx.offset(i as isize)).abs() >= *((*s).xtol_abs).offset(i as isize) {
            return 0 as ::core::ffi::c_int;
        }
        i = i.wrapping_add(1);
    }
...
unsafe fn nlopt_count_constraints(mut p: ::core::ffi::c_uint, mut c: *const nlopt_constraint) -> ::core::ffi::c_uint {
    let mut i: ::core::ffi::c_uint = 0;
...
unsafe fn nlopt_max_constraint_dim(mut p: ::core::ffi::c_uint, mut c: *const nlopt_constraint) -> ::core::ffi::c_uint {
    let mut i: ::core::ffi::c_uint = 0;
...
pub unsafe fn nlopt_compute_rescaling(
    ...
    while i < n && *dx.offset(i as isize) == *dx.offset(i.wrapping_sub(1 as ::core::ffi::c_uint) as isize) {
        i = i.wrapping_add(1);
    }
    if i < n {
        i = 1 as ::core::ffi::c_uint;
...
unsafe fn nlopt_seconds() -> ::core::ffi::c_double {
    ...
    start.duration_since(UNIX_EPOCH).expect("Time flies").as_secs_f64()
}
    ...
    *f = (*s).f.expect("non-null function pointer")(
    ...
    while j < (*s).p {
        ...
        while k < (*(*s).h.offset(j as isize)).m {
            *con.offset(i.wrapping_add((*(*s).h.offset(j as isize)).m).wrapping_add(k) as isize) =
                    ...
                    if s.ub.is_null() {
                        ...
                        if (s.xtmp).is_null() {
                            ...
                            if !(*stop).xtol_abs.is_null() {
                                ...
                                while j < n {
                                    if rhoend
                                        < *((*stop).xtol_abs).offset(j as isize) / (*(s.scale).offset(j as isize)).abs()
                                    {
                            ...
                            m = nlopt_count_constraints(m, fc)
                                .wrapping_add((2 as ::core::ffi::c_uint).wrapping_mul(nlopt_count_constraints(p, h)));
                            j = 0 as ::core::ffi::c_uint;
                            while j < n {
                                if nlopt_isinf(*lb.offset(j as isize)) == 0 {
                                    m = m.wrapping_add(1);
                            ...
                            if m != 0 && (s.con_tol).is_null() {
                                ...
                                j = 0 as ::core::ffi::c_uint;
                                while j < m {
                                    *s.con_tol.offset(j as isize) = 0 as ::core::ffi::c_int as ::core::ffi::c_double;
                                    j = j.wrapping_add(1);
                                }
                                i = 0 as ::core::ffi::c_uint;
                                j = i;
                                while i < s.m_orig {
                                    ...
                                    let mut jnext: ::core::ffi::c_uint = j.wrapping_add((*fc.offset(i as isize)).m);
                                    while j < jnext {
                                        *s.con_tol.offset(j as isize) =
                                            *(*fc.offset(i as isize)).tol.offset(j.wrapping_sub(ji) as isize);
                                        j = j.wrapping_add(1);
                                    }
                                    i = i.wrapping_add(1);
                                }
                                ...
                                while i < s.p {
                                    ...
                                    let mut jnext_0: ::core::ffi::c_uint = j.wrapping_add((*h.offset(i as isize)).m);
                                    while j < jnext_0 {
                                        *s.con_tol.offset(j as isize) =
                                            *(*h.offset(i as isize)).tol.offset(j.wrapping_sub(ji_0) as isize);
                                        j = j.wrapping_add(1);
                                    }
                                    ji_0 = j;
...
unsafe fn cobylb(
    ...
    *minf = f64::INFINITY;
    ...
    if *iprint >= 2 as ::core::ffi::c_int {
        fprintf(
            Io::stderr,
            &format!("cobyla: the initial value of RHO is {} and PARMU is set to zero.", rho),
        );
    }
    temp = 1.0f64 / rho;
    i__1 = *n;
        ...
        ) != 0
        {
            ...
            if f < (*stop).minf_max && feasible != 0 {
                ...
                if *(*stop).nevals_p == *iprint - 1 as ::core::ffi::c_int || *iprint == 3 as ::core::ffi::c_int {
                    fprintf(
                        Io::stderr,
                        &format!("cobyla: NFVALS = {}, F ={}, MAXCV ={}", *(*stop).nevals_p, f, resmax),
                    );
                    i__1 = iptem;
                ...
                *con.offset(*mpp as isize) = resmax;
                if ibrnch == 1 as ::core::ffi::c_int {
                    ...
                    while j <= i__1 {
                        ...
                        i__ = 1 as ::core::ffi::c_int;
                        while i__ <= i__2 {
                            temp += *simi.offset((j + i__ * simi_dim1) as isize) * *dx.offset(i__ as isize);
                            i__ += 1;
                        }
                        temp = temp.abs();
                        if temp > ratio {
                    ...
                    while j <= i__1 {
                            ...
                            || *sigbar.offset(j as isize) >= *vsig.offset(j as isize)
                        {
                            ...
                            if trured > 0.0f64 {
                                ...
                                i__ = 1 as ::core::ffi::c_int;
                                while i__ <= i__2 {
                                    d__1 = *dx.offset(i__ as isize) - *sim.offset((i__ + j * sim_dim1) as isize);
                                    temp += d__1 * d__1;
                                    i__ += 1;
                                }
                                temp = temp.sqrt();
                    ...
                    if jdrop == 0 as ::core::ffi::c_int {
                        ...
                        i__ = 1 as ::core::ffi::c_int;
                        while i__ <= i__1 {
                            *sim.offset((i__ + jdrop * sim_dim1) as isize) = *dx.offset(i__ as isize);
                            temp += *simi.offset((jdrop + i__ * simi_dim1) as isize) * *dx.offset(i__ as isize);
                            i__ += 1;
                        }
                        i__1 = *n;
                        i__ = 1 as ::core::ffi::c_int;
                        ...
                        k = 1 as ::core::ffi::c_int;
                        while k <= i__1 {
                            *datmat.offset((k + jdrop * datmat_dim1) as isize) = *con.offset(k as isize);
                            k += 1;
                        }
                    ...
                    if !(*(*stop).nevals_p > np) {
                        if jdrop <= *n {
                            if *datmat.offset((mp + np * datmat_dim1) as isize) <= f {
                                *x.offset(jdrop as isize) = *sim.offset((jdrop + np * sim_dim1) as isize);
                            } else {
                                let mut rhocur_0: ::core::ffi::c_double =
                                    *x.offset(jdrop as isize) - *sim.offset((jdrop + np * sim_dim1) as isize);
                                *sim.offset((jdrop + np * sim_dim1) as isize) = *x.offset(jdrop as isize);
                                i__1 = *mpp;
                                k = 1 as ::core::ffi::c_int;
                                while k <= i__1 {
                                    *datmat.offset((k + jdrop * datmat_dim1) as isize) =
                                        *datmat.offset((k + np * datmat_dim1) as isize);
                                    *datmat.offset((k + np * datmat_dim1) as isize) = *con.offset(k as isize);
                                    k += 1;
                                }
                                i__1 = jdrop;
                                k = 1 as ::core::ffi::c_int;
                        ...
                        if *(*stop).nevals_p <= *n {
                            jdrop = *(*stop).nevals_p;
                            *x.offset(jdrop as isize) += *sim.offset((jdrop + jdrop * sim_dim1) as isize);
                            continue;
                        }
                    }
                ...
                'c_6122: loop {
                    match current_block {
                                    ...
                                    *minf = fbest;
                                    if rho > rhoend {
                                        ...
                                        if parmu > 0.0f64 {
                                            ...
                                            k = 1 as ::core::ffi::c_int;
                                            while k <= i__1 {
                                                cmin = *datmat.offset((k + np * datmat_dim1) as isize);
                                                cmax = cmin;
                                                i__2 = *n;
                                                i__ = 1 as ::core::ffi::c_int;
                                                while i__ <= i__2 {
                                                    d__1 = cmin;
                                                    d__2 = *datmat.offset((k + i__ * datmat_dim1) as isize);
                                                ...
                                                if k <= *m && cmin < cmax * 0.5f64 {
                                                    temp = (if cmax >= 0.0f64 { cmax } else { 0.0f64 }) - cmin;
                                                    if denom <= 0.0f64 {
                                                        denom = temp;
                                                    } else {
                                        ...
                                        if *iprint >= 2 as ::core::ffi::c_int {
                                            fprintf(
                                                Io::stderr,
                                                &format!("cobyla: reduction in RHO to {} and PARMU ={}", rho, parmu),
                                            );
                                        }
                                        if *iprint == 2 as ::core::ffi::c_int {
                                            fprintf(
                                            ...
                                            while i__ <= i__1 {
                                                ...
                                                fprintf(
                                                    Io::stderr,
                                                    &format!("{}", *sim.offset((i__ + np * sim_dim1) as isize)),
                                                );
                                                i__ += 1;
                                            }
                                            if iptem < *n {
                        ...
                        _ => {
                            ...
                            if error > 0.1f64 {
                                if *iprint >= 1 as ::core::ffi::c_int {
                                    fprintf(Io::stderr, "cobyla: rounding errors are becoming damaging.");
                                }
                                ...
                                k = 1 as ::core::ffi::c_int;
                                while k <= i__2 {
                                    *con.offset(k as isize) = -*datmat.offset((k + np * datmat_dim1) as isize);
                                    i__1 = *n;
                                    j = 1 as ::core::ffi::c_int;
                                    while j <= i__1 {
                                        *w.offset(j as isize) =
                                            *datmat.offset((k + j * datmat_dim1) as isize) + *con.offset(k as isize);
                                        j += 1;
                                    }
                                    i__1 = *n;
                                    i__ = 1 as ::core::ffi::c_int;
                                    while i__ <= i__1 {
                                        ...
                                        while j <= i__3 {
                                            temp +=
                                                *w.offset(j as isize) * *simi.offset((j + i__ * simi_dim1) as isize);
                                            j += 1;
                                        }
                                        if k == mp {
                                            temp = -temp;
                                ...
                                while j <= i__1 {
                                    ...
                                    *veta.offset(j as isize) = weta.sqrt();
                                    if *vsig.offset(j as isize) < parsig || *veta.offset(j as isize) > pareta {
                                ...
                                if ibrnch == 1 as ::core::ffi::c_int || iflag == 1 as ::core::ffi::c_int {
                                    ...
                                    while i__ <= i__1 {
                                        ...
                                        if xi_0 + *dx.offset(i__ as isize) > *ub.offset(i__ as isize) {
                                            *dx.offset(i__ as isize) = *ub.offset(i__ as isize) - xi_0;
                                        }
                                        if xi_0 + *dx.offset(i__ as isize) < *lb.offset(i__ as isize) {
                                            *dx.offset(i__ as isize) = xi_0 - *lb.offset(i__ as isize);
                                        }
                                        i__ += 1;
                                    }
                                    ...
                                    *con.offset(mp as isize) = 0.0f64;
                                    ...
                                    while k <= i__1 {
                                        ...
                                        i__ = 1 as ::core::ffi::c_int;
                                        while i__ <= i__2 {
                                            sum -= *a.offset((i__ + k * a_dim1) as isize) * *dx.offset(i__ as isize);
                                            i__ += 1;
                                        }
                                        if k < mp {
                                    ...
                                    barmu = 0.0f64;
                                    prerec = *datmat.offset((*mpp + np * datmat_dim1) as isize) - resnew;
                                    if prerec > 0.0f64 {
                                        barmu = sum / prerec;
                                    }
                                    ...
                                    parmu = barmu * 2.0f64;
                                    if *iprint >= 2 as ::core::ffi::c_int {
                                        fprintf(Io::stderr, &format!("cobyla: increase in PARMU to {}", parmu));
                                    }
                                    ...
                                    while i__ <= i__1 {
                                        *dx.offset(i__ as isize) = dxsign
                                        ...
                                        let mut xi: ::core::ffi::c_double = *sim.offset((i__ + np * sim_dim1) as isize);
                                        loop {
                                            if xi + *dx.offset(i__ as isize) > *ub.offset(i__ as isize) {
                                                *dx.offset(i__ as isize) = -*dx.offset(i__ as isize);
                                            }
                                            if !(xi + *dx.offset(i__ as isize) < *lb.offset(i__ as isize)) {
                                                break;
                                            }
                                            if xi - *dx.offset(i__ as isize) <= *ub.offset(i__ as isize) {
                                                *dx.offset(i__ as isize) = -*dx.offset(i__ as isize);
                                        ...
                                        *sim.offset((i__ + jdrop * sim_dim1) as isize) = *dx.offset(i__ as isize);
                                        temp +=
                                            *simi.offset((jdrop + i__ * simi_dim1) as isize) * *dx.offset(i__ as isize);
                                        i__ += 1;
                                    }
                                    i__1 = *n;
                                    i__ = 1 as ::core::ffi::c_int;
                                    ...
                                    while j <= i__1 {
                                        ...
                                        *x.offset(j as isize) =
                                            *sim.offset((j + np * sim_dim1) as isize) + *dx.offset(j as isize);
                                        j += 1;
                                    }
                                    continue 'c_6104;
                                }
                ...
                i__ = 1 as ::core::ffi::c_int;
                while i__ <= i__1 {
                    *x.offset(i__ as isize) = *sim.offset((i__ + np * sim_dim1) as isize) + *dx.offset(i__ as isize);
                    i__ += 1;
                }
                ibrnch = 1 as ::core::ffi::c_int;
            }
            ...
            _ => {
                ...
                loop {
                    if mcon == *m {
                        ...
                        i__ = 1 as ::core::ffi::c_int;
                        while i__ <= i__1 {
                            optnew -= *dx.offset(i__ as isize) * *a.offset((i__ + mcon * a_dim1) as isize);
                            i__ += 1;
                        }
                    }
                    ...
                    if icon <= nact {
                        ...
                        if mcon > *m {
                            ...
                            while i__ <= i__1 {
                                temp += *sdirn.offset(i__ as isize)
                                    * *z__.offset((i__ + (nact + 1 as ::core::ffi::c_int) * z_dim1) as isize);
                                i__ += 1;
                            }
                            i__1 = *n;
                            i__ = 1 as ::core::ffi::c_int;
                            while i__ <= i__1 {
                                *sdirn.offset(i__ as isize) -=
                                    temp * *z__.offset((i__ + (nact + 1 as ::core::ffi::c_int) * z_dim1) as isize);
                                i__ += 1;
                            }
                        ...
                        while k > nact {
                            ...
                            i__ = 1 as ::core::ffi::c_int;
                            while i__ <= i__1 {
                                temp = *z__.offset((i__ + k * z_dim1) as isize) * *dxnew.offset(i__ as isize);
                                sp += temp;
                                spabs += (temp).abs();
                                i__ += 1;
                            }
                        ...
                        if tot != 0.0f64 {
                            ...
                            *vmultc.offset(nact as isize) = 0.0f64;
                            ...
                            while k <= i__1 {
                                d__1 = 0.0f64;
                                d__2 = *vmultc.offset(k as isize) - ratio * *vmultd.offset(k as isize);
                        ...
                        *iact.offset(nact as isize) = kk;
                        if mcon > *m && kk != mcon {
                            ...
                            while i__ <= i__1 {
                                sp +=
                                    *z__.offset((i__ + k * z_dim1) as isize) * *a.offset((i__ + kk * a_dim1) as isize);
                                i__ += 1;
                            }
                        ...
                        if mcon > *m {
                            ...
                            i__ = 1 as ::core::ffi::c_int;
                            while i__ <= i__1 {
                                temp += *sdirn.offset(i__ as isize) * *a.offset((i__ + kk * a_dim1) as isize);
                                i__ += 1;
                            }
                            temp += -1.0f64;
                            ...
                            i__ = 1 as ::core::ffi::c_int;
                            while i__ <= i__1 {
                                *sdirn.offset(i__ as isize) -= temp * *z__.offset((i__ + nact * z_dim1) as isize);
                                i__ += 1;
                            }
                            current_block = 9824026811267781195;
                        }
                    ...
                    i__ = 1 as ::core::ffi::c_int;
                    while i__ <= i__1 {
                        *dxnew.offset(i__ as isize) = *dx.offset(i__ as isize) + step * *sdirn.offset(i__ as isize);
                        i__ += 1;
                    }
                    if mcon == *m {
                        resold = resmax;
                        ...
                        while k <= i__1 {
                            ...
                            i__ = 1 as ::core::ffi::c_int;
                            while i__ <= i__2 {
                                temp -= *a.offset((i__ + kk * a_dim1) as isize) * *dxnew.offset(i__ as isize);
                                i__ += 1;
                            }
                    ...
                    loop {
                        ...
                        *vmultd.offset(k as isize) = zdotw / *zdota.offset(k as isize);
                        ...
                        while i__ <= i__1 {
                            *dxnew.offset(i__ as isize) -=
                                *vmultd.offset(k as isize) * *a.offset((i__ + kk * a_dim1) as isize);
                            i__ += 1;
                        }
                        k -= 1;
                    }
                    ...
                    while k <= i__1 {
                        if *vmultd.offset(k as isize) < 0.0f64 {
                            temp =
                                *vmultc.offset(k as isize) / (*vmultc.offset(k as isize) - *vmultd.offset(k as isize));
                            if temp < ratio {
                                ratio = temp;
                                icon = k;
                            }
                    ...
                    while k <= i__1 {
                        d__1 = 0.0f64;
                        d__2 = temp * *vmultc.offset(k as isize) + ratio * *vmultd.offset(k as isize);
                        *vmultc.offset(k as isize) = if d__1 >= d__2 { d__1 } else { d__2 };
                        k += 1;
                    }
                    if mcon == *m {
